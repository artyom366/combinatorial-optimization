...
import opt.gen.alg.service.strategy.impl.TournamentSelectionStrategyImpl;
...
public class GATournamentSelectionStrategyIntegrationTest {

    @Spy
    private GAServiceImpl gaService;

    @InjectMocks
    private TournamentSelectionStrategyImpl tournamentSelectionStrategy = new TournamentSelectionStrategyImpl();

    @Spy
    private GARunnerService<Long, String, Double> gaRunnerService = new GARunnerServiceImpl(tournamentSelectionStrategy);

    @Test
    public void testRunWithTournamentSelectionStrategy() throws Exception {
        ...
        assertThat("GA with tournament selection result should not be null", result, is(notNullValue()));
    }
}
