...
@Service
public class ResultTableControllerImpl implements ResultTableController<GASolution<Long, String>> {
    ...
    public TableView<GASolution<Long, String>> getResultTable() {
        ...
        final TableColumn hash = TableColumnFactory.<GASolution<Long, String>, String>getColumn(GENES, "hash", COLUMN_WIDTH_NORMAL);
        ...
        final TableColumn genesCount = TableColumnFactory.<GASolution<Long, String>, String>getColumn(GENES_COUNT, "genesCount", COLUMN_WIDTH_SMALL);
        final TableColumn locationsCount = TableColumnFactory.<GASolution<Long, String>, String>getColumn(LOCATIONS_COUNT, "locationsCount", COLUMN_WIDTH_SMALL);
